...
{
	FieldPositionCheckerGoalkeeper fieldPositionChecker(FieldSideInvalid);
...
{
	FieldPositionCheckerGoalkeeper fieldPositionChecker(FieldSideLeft);
...
void FieldPositionCheckerGoalkeeperTest::isPointInsideField_invalidSidePointInGoalZone_false()
{
	FieldPositionCheckerGoalkeeper fieldPositionChecker(FieldSideInvalid);
