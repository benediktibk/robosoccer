...
void TreeNodeResultGetBehindBall::execute()
{
	...
	vector<Pose> targetsShort = m_targetPositionFetcher.getTargetsBehindBall(m_ball, 0.3);
	vector<Pose> targetsLong = m_targetPositionFetcher.getTargetsBehindBall(m_ball, 0.6);
