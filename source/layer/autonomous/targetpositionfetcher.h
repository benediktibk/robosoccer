...
namespace Autonomous
{
	...
	public:
		...
		Common::Geometry::Point getAlternativeRobotPositionAtBallHeightAggressiveMode(const IntelligentBall &ball,const Common::Geometry::Point &alternativeRobotPosition) const;
