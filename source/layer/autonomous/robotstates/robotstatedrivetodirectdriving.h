#ifndef ROBOSOCCER_LAYER_AUTONOMOUS_ROBOTSTATES_ROBOTSTATEDRIVETODIRECTDRIVING_H
#define ROBOSOCCER_LAYER_AUTONOMOUS_ROBOTSTATES_ROBOTSTATEDRIVETODIRECTDRIVING_H
...
{
	class RobotStateDriveToDirectDriving :
			public RobotState
	{
	public:
		RobotStateDriveToDirectDriving(
