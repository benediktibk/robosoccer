...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.8\textwidth]{collaboration_graph_application.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.3\textwidth]{collaboration_graph_application_zoomed.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.8\textwidth]{inheritance_graph_robotstates.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.8\textwidth]{inheritance_graph_robotstates_driveto.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.8\textwidth]{inheritance_graph_robotstates_driveto_zoomed.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\textbf{Router:}
	\begin{itemize}
		\item gets width of robot
		\item calculate route
			\begin{itemize}
				\item gets start point and target point
				\item obstacles are circles
				\item considers only obstacles closer than 1 meter
				\item only save routes to target
			\end{itemize}
...
\begin{frame}
	...
	\centering
	\movie[showcontrols]{\includegraphics[height=0.8\textheight]{Pictures/demo-video.png}}{Pictures/roso_screen1.mov}
\end{frame}
