...
%    \end{itemize}
%    \begin{center}
%        \input{diagramms/goalie-tactics1}
%    \end{center}
%\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		%\includegraphics[width=\textwidth]{Pictures/ganttfinal1}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		%\includegraphics[width=\textwidth]{Pictures/ganttfinal2}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Some useless Facts}
		\begin{itemize}
			\item 28207 lines of code
			\item 100 classes ($+$ 19 mock classes and 74 test classes)
			\item 1393 commits
			\item 778 unit tests
