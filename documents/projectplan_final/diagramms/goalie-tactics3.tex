...
%		\draw [very thick, color=black!60!white, rounded corners=1.5cm] (3,-7) -- (0,-7) -- (0, 0) -- (0, 7) -- (3,7);
  ...
  \draw[ultra thick,->, >=latex'] (ballpos1) -- ($ (ballpos1)!1cm!(direction1) $);
  ...
  \coordinate (ballpos3) at (2.7,4.3);
  \coordinate (direction3) at (-1,1.8);
  \draw[ultra thick,->, >=latex', red] (ballpos3) -- ($ (ballpos3)!1cm!(direction3) $);
  \draw[thick, dashed, name path=ball3, red] (ballpos3) -- (direction3);
  \ball at (2.7,4.3) {};
