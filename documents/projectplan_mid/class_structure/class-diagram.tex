...
\begin{tikzpicture}[node distance=4.5cm]
	...
	\tikzstyle{class}=[
		...
		fill=blue!40, drop shadow, font=\tt,
	...
	\tikzstyle{inheritance}=[draw, ->, >=open triangle 90, thick]
	\tikzstyle{property}=[draw, ->, >=angle 60, thick]
	\tikzstyle{line}=[-, thick]
   ...
   % Classes
	...
	% Connections
	\path [inheritance] (controllablerobot.west) +(0,-1) -| (readablerobot);
